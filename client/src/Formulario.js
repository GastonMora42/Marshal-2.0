    ...
    isAuthenticated && (
      <div class="mb-5">
        ...
        <div class="alert alert-info text-center" role="alert">
          Hola {user.name} me gustaria conocer tu proyecto para poder brindarte
          ayuda personalizada
          <br></br>
          <h4>¡Bienvenido a Marshal!</h4>
        </div>
        <div className="datos">
          <div className="App">
            <div className="Lista">
          ...
          <div className="card text-center">
            <div className="card-header">Acerca de ti</div>
            <div className="card-body">
              ...
              <div className="input-group mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  placeholder="Ingrese el nombre de su marca"
                  aria-label="Nombre de su marca"
                  aria-describedby="basic-addon1"
                />
              </div>
              ...
              <div class="input-group mb-3">
                ...
                >
                  ...
                  <option value="Creador de contenido">
              ...
              <div className="input-group mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  placeholder="Ingrese el alcanze de su marca"
                  aria-label="Alcanze"
                  aria-describedby="basic-addon1"
                />
              </div>
              ...
              <div class="input-group mb-3">
                ...
                >
                  ...
                  <option value="Aumentar seguidores en instagram">
                    Aumentar seguidores en instagram
                  </option>
                  <option value="Crear y mantener imagen de marca">
                    Crear y mantener imagen de marca
                  </option>
                  <option value="Captar clientes potenciales">
                    Captar clientes potenciales
                  </option>
                  <option value="Expandir mi alcanze y llegar a nuevos clientes">
                    Expandir mi alcanze y llegar a nuevos clientes
                  </option>
                  <option value="Otros">Otros</option>
                </select>
              </div>
